...
HD_PWD='C:/Users/Administrator/Desktop/vmd/pcileech_enigma_x1/pcileech_enigma_x1.runs/drom_pcie_cfgspace_rw1c_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log drom_pcie_cfgspace_rw1c.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source drom_pcie_cfgspace_rw1c.tcl
